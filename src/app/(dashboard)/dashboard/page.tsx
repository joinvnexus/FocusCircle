...
import { TourLauncher } from "@/components/shared/tour-system";
...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      />
      <div className="relative overflow-hidden rounded-3xl bg-white/70 p-8 shadow-sm dark:bg-slate-900/60" data-tour="dashboard-header">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <Card className="overflow-hidden border-0 bg-white/80 shadow-sm dark:bg-slate-900/60" data-tour="weekly-chart">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="border-0 bg-white/80 shadow-sm dark:bg-slate-900/60" data-tour="today-tasks">
          <CardHeader>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-0 bg-white/80 shadow-sm dark:bg-slate-900/60" data-tour="notifications-preview">
          <CardHeader>
